...
current_date_obj = date(year=current_date.year, month=current_date.month, day=current_date.day)

app = Flask(__name__)
app.config["events"] = _generate_events(end_date=current_date_obj)
